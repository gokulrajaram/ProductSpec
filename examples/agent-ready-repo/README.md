...
An agent can then retrieve the Product Spec, pin the `spec_revision`, check the build graph, and ask for the evidence checklist before declaring the work done.
