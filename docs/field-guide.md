...
- Unknown **target** (threshold): keep the metric id, mark provisional, name an owner.
- Unknown **metric** (what to measure): do not invent a Success Metric row. Put the uncertainty in open_questions until the signal is clear.
